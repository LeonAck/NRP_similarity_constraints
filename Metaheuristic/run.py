...
def run_multiple_files(frequency,
                       ...
                       file_path="C:/Master_thesis/Metaheuristic/Input/sceschia-nurserostering/StaticSolutions",
                       similarity=False, reg_run=False, num_weeks=8):
    date_folder = create_date_time_for_folder()
    master_folder = "C:/Master_thesis/Metaheuristic/output_files" + "/" + date_folder
    ...
    if reg_run:
        ...
        settings_file_path = "C:/Master_thesis/Metaheuristic/Input/setting_files/no_similarity.json"
    elif similarity:
        folders_list = keep_files_with_weeks(folders_list, 8)
        settings_file_path = "C:/Master_thesis/Metaheuristic/Input/setting_files/similarity_settings.json"
    else:
        folders_list = keep_files_with_weeks(folders_list, 8)
        settings_file_path = "C:/Master_thesis/Metaheuristic/Input/setting_files/no_similarity.json"
    ...
    for i in range(frequency):
        ...
        for folder_name in folders_list:
            input_dicts.append(folder_to_json(
                path="C:/Master_thesis/Metaheuristic/Input/sceschia-nurserostering/Datasets/JSON",
                solution_path="C:/Master_thesis/Metaheuristic/Input/sceschia-nurserostering/StaticSolutions",
